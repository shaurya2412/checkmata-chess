...
export default function Sidebar({ className }: SidebarProps) {
  ...
  return (
    <nav
      className={cn(
        `relative hidden h-screen pt-4 md:block bg-bgAuxiliary1 text-textMain w-12 lg:w-36 top-0 relative sticky`,
        className
      )}
    >
      <div className="flex flex-col h-full justify-between">
        <div className="flex flex-col justify-start">
          {isOpen && <span className="text-center text-2xl font-bold tracking-tighter ">CheckMate</span>}
